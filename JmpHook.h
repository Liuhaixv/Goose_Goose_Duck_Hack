...
{
public:
    JmpHook(int64_t offsetToGameAssembly, std::vector<byte> rawBytes) {
    ...
    JmpHook(int64_t offsetToGameAssembly, std::vector<byte> rawBytesPart1, std::vector<byte> rawBytesPart2) {
        this->offsetToGameAssembly = offsetToGameAssembly;
